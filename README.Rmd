...
- [`buildObservationPeriod()`](https://ohdsi.github.io/OmopConstructor/reference/buildObservationPeriod.html) to generate observation periods based on the data already in the `cdm` object.
